...
export default function EditNewsTable() {

    const [isAllChecked, setIsAllChecked] = useState(false);

    const [news, setNews] = useState([
        { id: 1, title: 'News 1', date: '11.11.2023' },
        { id: 2, title: 'News 2', date: '11.11.2023' },
        { id: 3, title: 'News 3', date: '11.11.2023' },
        { id: 4, title: 'News 4', date: '11.11.2023' },
        { id: 5, title: 'News 5', date: '11.11.2023' },
        { id: 6, title: 'News 6', date: '11.11.2023' },
        { id: 7, title: 'News 7', date: '11.11.2023' },
        { id: 8, title: 'News 8', date: '11.11.2023' },
        { id: 9, title: 'News 9', date: '11.11.2023' },
        { id: 10, title: 'News 10', date: '11.11.2023' },
    ]);
    ...
    return (
        <div>
            <table className="w-[603px] text-sm text-left text-gray-700 border rounded-lg border-[#E4E7EC]">
                <thead className="text-xs text-gray-700 bg-gray-50 border-b border-[#E4E7EC]">
                <tr>
            ...
            <div className="w-[528px] bg-white px-4 py-3 flex items-center justify-between">
                <div className="flex items-center text-sm text-gray-700">
                    ...
                    <div className="mr-4">
                        <span>Результатов: {news.length}</span>
                    </div>
                </div>
